...
1. There are no jars. You start with a reusable canteen, which can be filled from water sources in the world, like sinks, toilets, water coolers etc.
2. There are 3 types of drink containers - a canteen for water, a thermal cup/mug for teas and coffees, and a sports bottle for juices and smoothies.
3. The blue barrels found in the world can be picked up, repaired, and placed as water storage. A single barrel holds 30 water, and 4 stack pallet holds 120.
4. Standing water in the world cannot be used for anything except filling buckets and drinking with an empty hand.
5. In order to cook any recipe that requires water, you need clean water in your canteen.
6. Water and other drinks cannot be mixed in the same container. If you have murky water in your canteen, you'll need to store it, boil it, or dump it before you can fill the canteen with another type of water.
7. Same method applies to other drinks containers. You can't mix coffee and Blackstrap coffee, nor can you mix tea. You'll have to drink it first to use the cup, or find another cup. You also can't mix yucca juice with yucca smoothies.
8. Thermal cups, sports bottles, and additional canteens can be found in loot, or at traders.
9. Bottles found in the world can be picked up, and are needed to craft beer. Bottles are always returned when drinking beer, and are not craftable.

## INVENTORY

 - You have a **MAXIMUM** bag capacity of 60 slots, and you start with 30 unencumbered slots unlocked.
 
 - To increase your inventory capacity, you need to find bag upgrades in the world, which will unlock an additional 10 slots of inventory space per upgrade.
 
 - You have to use the bag upgrades in the correct order. You cannot unlock the biggest backpack with out first unlocking the big backpack AND the bigger backpack.

 - There are schematics to be found or purchased from traders to unlock recipes for crafting the bag upgrades.

 - Encumberance works exactly as it does in vanilla - the bag upgrades only unlock *usable* inventory space. You'll still need Pack Mule or pocket mods to reduce encumberance. 
...
## BLOCKS/WORKSTATIONS
 ...
 - Glue requires a beaker to craft at the campfire.
 ...
 - Beehive. Find a bee in tree stumps by harvesting the stump. Will produce honey over time when placed in a beehive. A Bee Smoker for speeding up collection and a Bee Frame for increasing quantity can be purchased or unlocked with workstation progression.
...
## BUFFS/DEBUFFS
 ...
 - Insulated liner and cooling mesh mods for armour are back. Armour has very little weather protection now, so for permanent resistance to hot and cold, these armour mods will be essential.
...
## FOOD/FARMING
 ...
 - No food, *except* Sham Chowder, replenishes health - just food and water.
 ...
 - New plant - lavender. Purple flower found growing in the wild and in some POIs. Seeds can be crafted from lavender flowers, no unlock required. Lavender flowers can be found in loot and trader stock, and Lavender seeds in trader stock.
 ...
 - Red tea and Goldenrod tea require a higher ingredient count.
...
## PROGRESSION
 ...
 - All tool and weapon skills are now governed by action skills.
...
## VEHICLES
 ...
 - Five new vehicles, a scooter, a dirt bike, a quad bike, a dune buggy, and a semi truck. The semi truck has a craftable trailer mod, which doubles it's inventory capacity.
